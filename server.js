...
// Special requests: { id, student, room, message, date, hours, status }
let specialRequests = [];
...
// ==================================================================
// ⭐ UPDATED SPECIAL REQUEST ROUTES — NOW USES room + date ⭐
// ==================================================================

// STUDENT SENDS SPECIAL REQUEST
app.post("/api/special-request", (req, res) => {
  const { student, room, message, date, hours } = req.body;

  if (!student || !room || !message || !date || !hours) {
    return res.json({
      success: false,
